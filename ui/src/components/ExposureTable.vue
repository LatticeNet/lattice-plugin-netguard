 ...
 */
import { ChevronDown, ChevronRight, ChevronUp, Radar } from "@lucide/vue";
...
import { driftLabel, driftToneFor, driftUnknownReason, type PostureRow } from "../posture";
...
<template>
  <section class="panel">
    ...
    <div v-if="empty" class="empty">
      ...
      <span>Clear the search. If it is empty, this session can see no nodes at all.</span>
    </div>
  </section>
</template>
